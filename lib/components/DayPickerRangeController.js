...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isNextDay = __webpack_require__(51);
	...
	var _isBeforeDay = __webpack_require__(52);

	var _isBeforeDay2 = _interopRequireDefault(_isBeforeDay);

	var _getVisibleDays = __webpack_require__(53);
	...
	var _FocusedInputShape = __webpack_require__(54);
	...
	var _DayPicker = __webpack_require__(55);
	  ...
	  _createClass(DayPickerRangeController, [{
	      ...
	      function componentWillReceiveProps(nextProps) {
	        ...
	        if (didStartDateChange || didEndDateChange) {
	          if (this.props.startDate && this.props.endDate) {
	            modifiers = this.deleteModifierFromRange(modifiers, this.props.startDate.clone().add(1, 'day'), this.props.endDate, 'selected-span');
	          }
	        ...
	        if (minimumNights > 0 || minimumNights !== this.props.minimumNights) {
	          if (this.props.startDate && (didFocusChange || didStartDateChange)) {
	            modifiers = this.deleteModifierFromRange(modifiers, this.props.startDate, this.props.startDate.clone().add(minimumNights, 'days'), 'blocked-minimum-nights');
	          }
	    ...
	    value: function () {
	      function onDayClick(day, e) {
	        ...
	        if (focusedInput === _constants.START_DATE || fakeFocusedInputStartDate) {
	    ...
	    value: function () {
	      function onPrevMonthClick() {
	        ...
	        var prevMonth = currentMonth.clone().subtract(1, 'months');
	    ...
	    value: function () {
	      function doesNotMeetMinimumNights(day) {
	        ...
	        var focusedInput = _props11.focusedInput;
	        var minimumNights = _props11.minimumNights;
	    ...
	    value: function () {
	      function isBlocked(day) {
	        ...
	        var isDayBlocked = _props15.isDayBlocked;
	        var isOutsideRange = _props15.isOutsideRange;
	    ...
	    value: function () {
	      function render() {
	        ...
	        var numberOfMonths = _props16.numberOfMonths;
	        var orientation = _props16.orientation;
	        var monthFormat = _props16.monthFormat;
	        var renderMonth = _props16.renderMonth;
	        var navPrev = _props16.navPrev;
	        var navNext = _props16.navNext;
	        var onOutsideClick = _props16.onOutsideClick;
	        var withPortal = _props16.withPortal;
	        var enableOutsideDays = _props16.enableOutsideDays;
	        var initialVisibleMonth = _props16.initialVisibleMonth;
	        var hideKeyboardShortcutsPanel = _props16.hideKeyboardShortcutsPanel;
	        var daySize = _props16.daySize;
	        var focusedInput = _props16.focusedInput;
	        var renderDay = _props16.renderDay;
	        var renderCalendarInfo = _props16.renderCalendarInfo;
	        var onBlur = _props16.onBlur;
	        var isFocused = _props16.isFocused;
	        var showKeyboardShortcuts = _props16.showKeyboardShortcuts;
	        var isRTL = _props16.isRTL;
	        var _state7 = this.state;
	        var phrases = _state7.phrases;
